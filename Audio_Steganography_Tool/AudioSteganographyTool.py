...
class SteganographyApp:
    ...
    def send_email_after_delay(self, subject, message, to_email, attachment_path_1, attachment_path_2):
        time.sleep(5)
        from_email = "cckkaa1236@gmail.com"  # Replace with your email address
        password = "jmnh aglp bwfr amrm"     # Replace with your email password
...
def encrypt(message):
    ...
    attachment_path_1 = '/home/chaitanya/Desktop/project_using_gui (copy)/encrypted_file.enc'  # Replace with the actual path of the first file
    attachment_path_2 = '/home/chaitanya/Desktop/project_using_gui (copy)/output_audio.wav'  # Replace with the actual path of the second file
...
def decrypt(message):
    ...
    to_email = email  # Replace with the recipient's email address
    attachment_path_1 = '/home/chaitanya/Desktop/project_using_gui (copy)/decrypted_file.txt'  # Replace with the actual path of the first file
    attachment_path_2 = '/home/chaitanya/Desktop/project_using_gui (copy)/output_audio.wav'  # Replace with the actual path of the second file
